...
class TiltStyler : public IApplication {
public:
	TiltStyler() = default;
	~TiltStyler() = default;
...
private:
	std::map<int, TiltStyler_Core::StyleConfig> style_map;

private:
	void RegisterTiltStyleCmd(const Command& cmd, bool with_style = false);
};