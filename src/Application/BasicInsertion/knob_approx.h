...
class KnobApprox : public IApplication {
public:
	KnobApprox() = default;
	~KnobApprox() = default;
...
class KnobAddApprox : public IApplication {
public:
	KnobAddApprox() = default;
	~KnobAddApprox() = default;
...
class KnobSlamApprox : public IApplication {
public:
	KnobSlamApprox() = default;
	~KnobSlamApprox() = default;
